...
여기서 스토어는 /files
  ...
  HTML FORM 사용
   ...
   컨트롤 URI
    GET, POST 만 지원하는 제약을 해결하기 위해 동사로된 리소스 경로 사용
...
- 쿠키
 ...
 예) set-cookie: sessionId=abcd; expires=Sat, 26-Dec-2020 00:00:00 GMT; path=/; domain=.google.com; Secure
...
- 검증 헤더와 조건부 요청1
 ...
 서버 -> 클라이언트
  클라이언트에서 보낸 If-modified-since 를 확인해서 수정된 내용이 없음 :
